...
public class MemoFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MemoViewModel memoViewModel = ViewModelProviders.of(getActivity()).get(MemoViewModel.class);
        ...
        memoViewModel.getMemos().observe(this.getViewLifecycleOwner(), new Observer<List<Announcement>>() {
            ...
            public void onChanged(List<Announcement> announcements) {
                MemoAdapter memoAdapter = new MemoAdapter(announcements, new MemoAdapter.ClickListener() {
                    @Override
