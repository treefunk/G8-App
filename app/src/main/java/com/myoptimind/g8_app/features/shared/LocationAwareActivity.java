...
public abstract class LocationAwareActivity extends SingleActivityFragment implements LocationListener {
        ...
        locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                if (locationResult == null) {
                    Toast.makeText(LocationAwareActivity.this,getString(R.string.dialog_text_turn_gps),Toast.LENGTH_SHORT).show();
                    return;
                }
                for (Location location : locationResult.getLocations()) {
                    ...
                    onRequestCoordinates(lat_,long_);
                }
            }
            ...
            public void onLocationAvailability(LocationAvailability locationAvailability) {
                ...
                onCheckAvailability(locationAvailability.isLocationAvailable());
            }
        };
